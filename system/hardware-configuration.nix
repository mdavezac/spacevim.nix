...
# to /etc/nixos/configuration.nix instead.
{
  ...
  hardware.nvidia = {
    ...
    #       url = "https://raw.githubusercontent.com/gentoo/gentoo/c64caf5352e8b82edbaa2204aaf055cbcabfc8d1/x11-drivers/nvidia-drivers/files/nvidia-drivers-535.43.22-kernel-6.7.patch";
    #       hash = "sha256-eZi0000000000000000000000000000000FFGp24dVg=";
    #     };
    #   in
