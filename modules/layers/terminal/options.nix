...
in
{
  options.spacenix = terminal-layer-options {
    repl = lib.mkOption {
      type = lib.types.submodule {
        ...
        options.repls = lib.mkOption {
          type = lib.types.attrsOf lib.types.str;
          default = { };
          description = "For each filetype, the REPL to use.";
        };
        options._default_repls = lib.mkOption {
          type = lib.types.attrsOf lib.types.str;
          default = { };
          description = "For each filetype, the internally defined default REPL to use.";
        };
      };
      default = { };
    };
